...
import tempfile
from oks_connector._shared import _fsync_dir, sha256_file
from oks_connector.constants import SCHEMA_VERSION, RAW_V2_VERSION
from oks_connector.route import is_url


def validate_bundle(bundle: Path) -> dict[str, Any]:
    from oks_connector.extractors.markitdown import markdown_asset_references
